...
import data from "../../Data/Birthday.json"; // Import JSON

const BirthdayGallery = () => {
    // If JSON is just an array, no need for `.Birthday`
    const allImages = data.Birthday;

    const initialLoad = 12;
    const loadMoreCount = 6;

    const [visibleImages, setVisibleImages] = useState(
        allImages.slice(0, initialLoad)
    );

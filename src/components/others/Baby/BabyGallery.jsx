    ...
    const fetchMoreImages = () => {
        requestAnimationFrame(() => {
            setVisibleImages((prev) => [
                ...prev,
                ...Babyset.slice(prev.length, prev.length + loadMoreCount),
            ]);
        });
    };
        ...
        <section className="px-4 md:px-24 py-8">
            <PhotoProvider>
                <InfiniteScroll
                    ...
                    hasMore={visibleImages.length < Babyset.length}
                    loader={
                        <h4 className="text-center text-gray-500 mt-4">Loading more...</h4>
                    }

...
import data from "../../Data/Reception.json";

export default function ReceptionGallery() {
    const PortraitsDataset = data.RecptionDataset
    ...
    return (
        <div className="relative bg-white py-24 px-6 md:px-6 lg:px-32">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {PortraitsDataset.slice(0, visibleCount).map((photo) => (
                    <Link
                        key={photo.id}
            ...
            <div className="flex justify-end mt-8 gap-4">
                {visibleCount < PortraitsDataset.length && (
                    <button
